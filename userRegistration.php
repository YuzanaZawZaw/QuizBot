									...
									<div class="mt-3">                                    
                                        <form method="post" action="registrationAction.php">	
                                            <div class="form-group last mb-3">
                                                ...
                                                <select name="userRole" class="form-select" aria-label="Default select example" required>
                                            ...
                                            <div class="form-group first">
                                                ...
                                                <input type="text" class="form-control" name="regName" placeholder="Enter name..." required/>					
                                            </div>					
                                            <div class="form-group first">
